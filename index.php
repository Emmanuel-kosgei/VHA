...
<head><title>Virtual Healthcare Assistant</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">
      <a class="navbar-brand text-dark" href="#myPage"><strong>Virtual Healthcare Assistant</strong></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#location">Hospitals  <span class="caret"></span></a>
          <ul class="dropdown-menu"> 
       <li> <a href="location map/bungoma.html">Bungoma</a></li>
      <li>  <a href='location map/nairobi.html'>Nairobi</a></li>
       <li> <a href="location map/mombasa.html">Mombasa</a></li>
      <li>  <a href="location map/khulna.html">Nakuru</a></li>
     <li>   <a href='location map/mymensingh.html'>Kisumu</a></li>
     <li>   <a href='location map/rajshahi.html'>Eldoret</a></li>
...
<div id="#" class="bg-1">
  <div class="container">
    <h3 class="text-center">Virtual Healthcare Assistant</h3>
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px"  id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker" style="width:30px"></i>Bungoma, Kenya<br>
        <i class="fa fa-phone" style="width:30px"></i> Phone: +254110703855<br>
        <i class="fa fa-envelope" style="width:30px"> </i> Email:  ekosgei1108@gmail.com<br>
      </div>
      <?php
...
<footer class="text-center">
  ...
  <p>&copy; 2025 <a href="http://labaidgroup.com/specialized/doctor" data-toggle="tooltip" title="e-Healthcare">Virtual Healthcare Assistant</a></p> 
</footer>
<script>
