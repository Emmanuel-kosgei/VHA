...
$doctor_id = $_SESSION['doctor_id']; // Get the doctor ID from session

// Get the patient ID from the URL parameter
$patient_id = isset($_GET['patient_id']) ? $_GET['patient_id'] : null;

// If no patient ID is provided, show an error
if (!$patient_id) {
...
<div class="container">
    ...
    <h1>Patient Details - <?= $patient['f_name'] ?> <?= $patient['l_name'] ?></h1>
